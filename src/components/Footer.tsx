export function Footer() {
  ...
  return (
    <footer className="w-full bg-gray-900 border-t border-gray-800 relative">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* About Section */}
          <div className="md:col-span-2">
            <h3 className="text-xl mb-4 text-white">ZODIACX.</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xl mb-4 text-white">Services</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} ZODIACX. All rights reserved.
          </p>
